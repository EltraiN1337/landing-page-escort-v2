...
/**
 * Set uncode_gallery as available CPT for VC.
 */
// function uncode_set_vc_editor_cpts() {
// 	if ( function_exists( ( 'vc_editor_post_types' ) ) && function_exists( ( 'vc_editor_set_post_types' ) ) && get_option('uncode_gallery_installed') != true ) {
// 		$saved_post_types = vc_editor_post_types();

// 		if ( ! in_array( 'uncode_gallery', $saved_post_types ) ) {
// 			$saved_post_types[] = 'uncode_gallery';
// 			vc_editor_set_post_types( $saved_post_types );
// 			update_option('uncode_gallery_installed', true);
// 		}
// 	}
// }
// add_action('admin_init', 'uncode_set_vc_editor_cpts');
